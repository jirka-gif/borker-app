...
interface ForeignerContractPageProps {
  insurer: string;
  amountLabel: string;
  onBack: () => void;
...
const contractNumber = '4408822901';
const paymentUrl = 'https://platebnibrana.example/pay/4408822901';
...
export function ForeignerContractPage({
  insurer,
  amountLabel,
  onBack,
  onDownloadRecord,
}: ForeignerContractPageProps) {
  const router = useRouter();

  const documents: DocItem[] = [
    { name: 'Pojistná smlouva', desc: 'Smlouva o zdravotním pojištění cizinců', source: 'Pojišťovna' },
    {
    ...
    {
      name: 'Karta pojištěnce / potvrzení o pojištění',
      desc: 'Doklad pro úřady a poskytovatele péče',
      source: 'Pojišťovna',
    },
    {
      ...
      <div className="flex items-start gap-3 rounded-2xl border border-success/30 bg-success-bg px-6 py-5">
        ...
        <div>
          ...
          <p className="mt-0.5 text-sm text-muted">
            Zdravotní pojištění cizinců u {insurer} je připravené. Pro aktivaci uhraďte pojistné.
          </p>
