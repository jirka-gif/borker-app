...
interface PropertyContractPageProps {
  onStepChange?: (step: number) => void;
  onDownloadRecord?: () => void;
}

// Mock data (v reálu z API pojišťovny po sjednání).
const contractNumber = '7045123988';
const insurer = 'ČSOB Pojišťovna';
const amount = '1 500 Kč';
const variableSymbol = '7045123988';
const paymentUrl = 'https://platebnibrana.example/pay/7045123988';
...
export default function PropertyContractPage({
  onStepChange,
  onDownloadRecord,
}: PropertyContractPageProps) {
  const router = useRouter();

  const documents: DocItem[] = [
    { name: 'Pojistná smlouva', desc: 'Smlouva o pojištění majetku', source: 'Pojišťovna' },
    {
    ...
    <div>
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <Button variant="secondary" onClick={() => onStepChange?.(4)}>
            Zpět na záznam
          </Button>
