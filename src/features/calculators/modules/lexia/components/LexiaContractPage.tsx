...
const contractNumber = '7711204588';
const insurer = 'Lexia';
const paymentUrl = 'https://platebnibrana.example/pay/7711204588';
...
export function LexiaContractPage({ amountLabel, onBack, onDownloadRecord }: Props) {
  const router = useRouter();

  const documents: DocItem[] = [
    { name: 'Pojistná smlouva', desc: 'Smlouva o pojištění právní ochrany', source: 'Pojišťovna' },
    ...
    { name: 'Pojistné podmínky', desc: 'Všeobecné a doplňkové pojistné podmínky', source: 'Pojišťovna' },
    {
      ...
      desc: 'Záznam dle § 77 a 79 ZDPZ vytvořený v kroku 3',
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start gap-3 rounded-2xl border border-success/30 bg-success-bg px-6 py-5">
        ...
        <div>
          <h1 className="text-lg font-bold text-foreground">Sjednání právní ochrany dokončeno</h1>
          <p className="mt-0.5 text-sm text-muted">
            Právní ochrana {insurer} je připravená. Pro aktivaci uhraďte pojistné.
          </p>
