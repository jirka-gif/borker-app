...
const contractNumber = '3380561902';
const insurer = 'ČSOB Pojišťovna';
const paymentUrl = 'https://platebnibrana.example/pay/3380561902';
...
export function ZamZamContractPage({ amountLabel, onBack, onDownloadRecord }: Props) {
  const router = useRouter();

  const documents: DocItem[] = [
    { name: 'Pojistná smlouva', desc: 'Smlouva o pojištění odpovědnosti z výkonu povolání', source: 'Pojišťovna' },
      ...
      <div className="flex items-start gap-3 rounded-2xl border border-success/30 bg-success-bg px-6 py-5">
        ...
        <div>
          ...
          <p className="mt-0.5 text-sm text-muted">
            Pojištění ZamZam u {insurer} je připravené. Pro aktivaci uhraďte pojistné.
          </p>
