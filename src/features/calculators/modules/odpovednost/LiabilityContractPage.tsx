...
interface LiabilityContractPageProps {
  amountLabel: string;
  onBack: () => void;
...
const contractNumber = '9013477205';
const insurer = 'Star Insurance Group';
const paymentUrl = 'https://platebnibrana.example/pay/9013477205';
...
export function LiabilityContractPage({
  amountLabel,
  onBack,
  onDownloadRecord,
}: LiabilityContractPageProps) {
  const router = useRouter();

  const documents: DocItem[] = [
    { name: 'Pojistná smlouva', desc: 'Smlouva o pojištění odpovědnosti', source: 'Pojišťovna' },
    {
      ...
      <div className="flex items-start gap-3 rounded-2xl border border-success/30 bg-success-bg px-6 py-5">
        ...
        <div>
          ...
          <p className="mt-0.5 text-sm text-muted">
            Pojištění odpovědnosti je připravené. Pro aktivaci uhraďte první pojistné.
          </p>
