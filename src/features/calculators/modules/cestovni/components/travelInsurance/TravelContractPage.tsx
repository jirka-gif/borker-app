...
interface TravelContractPageProps {
  onBack?: () => void;
  onDownloadRecord?: () => void;
}

// Mock data (v reálu z API pojišťovny po sjednání).
const contractNumber = '5520347711';
const insurer = 'Travel Guard';
const amount = '1 290 Kč';
const variableSymbol = '5520347711';
const paymentUrl = 'https://platebnibrana.example/pay/5520347711';
...
export function TravelContractPage({ onBack, onDownloadRecord }: TravelContractPageProps) {
  const router = useRouter();

  const documents: DocItem[] = [
    { name: 'Pojistná smlouva', desc: 'Smlouva o cestovním pojištění', source: 'Pojišťovna' },
    {
      ...
      <div className="flex items-start gap-3 rounded-2xl border border-success/30 bg-success-bg px-6 py-5">
        ...
        <div>
          ...
          <p className="mt-0.5 text-sm text-muted">
            Cestovní pojištění u {insurer} je připravené. Pro aktivaci uhraďte pojistné.
          </p>
